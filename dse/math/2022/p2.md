...
**14.** 圖中，第 $1$ 個圖案包含 $8$ 粒點子。對任意正整數 $n$，第 $(n+1)$ 個圖案是由第 $n$ 個圖案加上 $(2n+6)$ 粒點子所組成。求第 $7$ 個圖案的點子數目。![圖](https://raw.githubusercontent.com/yukkit/log/main/dse/math/2022/images/p2/14.png)
A. $52$
B. $68$
C. $86$
D. $106$
...
**17.** 圖中， $M$ 及 $N$ 分別為 $PQ$ 及 $QR$ 上的點使得 $PM:MQ=5:6$ 及 $QN:NR=3:4$。若四邊形 $MNRP$ 的面積為 $59\text{ cm}^{2}$，則 $\Delta MNQ$ 的面積為 ![圖](https://raw.githubusercontent.com/yukkit/log/main/dse/math/2022/images/p2/17.png)
A. $17\text{ cm}^{2}$
B. $18\text{ cm}^{2}$
C. $19\text{ cm}^{2}$
D. $20\text{ cm}^{2}$

**18.** 圖中，長方形 $ABCD$ 的周界為 $170\text{ cm}$。已知 $EBF$ 為一直線及 $\angle AEB=\angle BFC=90^{\circ}$。若 $AE=24\text{ cm}$ 及 $BC=34\text{ cm}$，則 $EF=$ ![圖](https://raw.githubusercontent.com/yukkit/log/main/dse/math/2022/images/p2/18.png)
A. $45\text{ cm}$
B. $51\text{ cm}$
C. $61\text{ cm}$
D. $75\text{ cm}$

**19.** 圖中， $ABC$ 為一等邊三角形。設 $D$ 及 $E$ 分別為 $AC$ 及 $BC$ 上的點使得 $AD=CE$。若 $\angle CBD=38^{\circ}$，則 $\angle AEB=$ ![圖](https://raw.githubusercontent.com/yukkit/log/main/dse/math/2022/images/p2/19.png)
A. $73^{\circ}$
B. $75^{\circ}$
C. $78^{\circ}$
D. $82^{\circ}$
...
I. $a+b=180^{\circ}$
II. $b+c=360^{\circ}$
III. $c+d=540^{\circ}$ ![圖](https://raw.githubusercontent.com/yukkit/log/main/dse/math/2022/images/p2/20.png)
A. 只有 I 及 II
B. 只有 I 及 III
C. 只有 II 及 III
D. I、II 及 III

**21.** 圖中， $O$ 為圓 $ABC$ 的圓心。若 $\angle ABO=36^{\circ}$ 及 $\angle BOC=164^{\circ}$，則 $\angle ACO=$ ![圖](https://raw.githubusercontent.com/yukkit/log/main/dse/math/2022/images/p2/21.png)
A. $41^{\circ}$
B. $46^{\circ}$
C. $52^{\circ}$
D. $64^{\circ}$

**22.** 圖中， $ABC$ 為一直角三角形且 $\angle ABC=90^{\circ}$。設 $D$ 及 $E$ 分別為 $AC$ 及 $BC$ 上的點使得 $ABED$ 為一圓內接四邊形。若 $AB=660\text{ cm}$、$AD=572\text{ cm}$ 及 $BE=275\text{ cm}$，則 $CD=$ ![圖](https://raw.githubusercontent.com/yukkit/log/main/dse/math/2022/images/p2/22.png)
A. $429\text{ cm}$
B. $715\text{ cm}$
C. $728\text{ cm}$
D. $845\text{ cm}$
...
I. $m<0$
II. $n>3$
III. $m+n=0$ ![圖](https://raw.githubusercontent.com/yukkit/log/main/dse/math/2022/images/p2/24.png)
A. 只有 I 及 II
B. 只有 I 及 III
C. 只有 II 及 III
D. I、II 及 III
...
**38.** 圖中， $ABCD$ 為一圓。 $PA$ 及 $QB$ 分別為該圓在 $A$ 及 $B$ 的切線。若 $\angle ADC=79^{\circ}$、 $\angle CBQ=39^{\circ}$ 及 $\angle DAP=42^{\circ}$，則 $\angle BCD=$ ![圖](https://raw.githubusercontent.com/yukkit/log/main/dse/math/2022/images/p2/38.png)
A. $76^{\circ}$
B. $79^{\circ}$
C. $81^{\circ}$
D. $82^{\circ}$
...
**40.** 圖中， $ABCDEFGH$ 為一正方體。設 $\alpha$ 為平面 $AFG$ 與平面 $AFH$ 間的交角，而 $\beta$ 為平面 $AFH$ 與平面 $AFGH$ 間的交角。下列何者正確？ ![圖](https://raw.githubusercontent.com/yukkit/log/main/dse/math/2022/images/p2/40.png)
